...
- **ZIP下载**：📦 **新功能** - 自动打包成ZIP文件下载到本地
  - 单个笔记下载：选择图片后点击下载，自动生成ZIP
...
- `POST /api/batch_parse` - 批量解析笔记链接
- `POST /api/download_zip` - ZIP下载（推荐，直接下载到本地）
